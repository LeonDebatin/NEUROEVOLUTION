...
def gp_cross_validation(X, y, batch_size, shuffle, kfold, initializer, ps, n_iter,  sspace,   selection_pressure, selection_method, mutation_prob, mutation_method, xo_prob, xo_method, has_elitism, allow_reproduction,log_path_cv, log_path_train, ffunction, seed,  device, id=None):
    results = []
